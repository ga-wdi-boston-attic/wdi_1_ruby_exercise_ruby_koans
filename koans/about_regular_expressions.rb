...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # THINK ABOUT IT:
    #
    # When would * fail to match? If something before it fails.
  end
  ...
  #
  # Why? They try and match as much as possible.
  ...
  # THINK ABOUT IT:
  #
  # Explain the difference between a character class ([...]) and alternation (|).  A character class matches a range of characters, while an alternation matches specific instances within. Taken from online.
  ...
  end #So "one two-three".sub(/(t\w*)/) { $1[0, 1] } searches for the pattern t\w*. This finds the substring "two". Since the whole thing is in a capturing group, this substring is stored in $1. Now the block is called and returns "two"[0,1], which is "t". So "two" is replaced by "t" and you get "one t-three". From SO

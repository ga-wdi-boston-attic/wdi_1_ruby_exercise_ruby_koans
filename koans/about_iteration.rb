...
class AboutIteration < Neo::Koan
  ...
  # THIS in_ruby_version... BROKE IN MY SYSTEM, RUNNING RUBY 2.1.2
  ...
  # SUBSTITUE METHOD FOR ABOVE. SAME SYNTAX, IGNORING VERSION
  def as_name(name)
    name.to_sym
  end
  ...
  def test_inject_will_blow_your_mind
    ...
    # In these examples, we pass an accumulator to the element (0).
    # so first pass = 0 + 2 = 2
    # second pass = 2 + 3 = 5
    # third pass = 5 + 4 = 9
    # INJECT IS POWERFUL
